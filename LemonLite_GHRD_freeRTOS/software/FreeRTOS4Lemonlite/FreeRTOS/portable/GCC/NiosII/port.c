...
#define SYS_CLK_IRQ SYS_TIMER_IRQ
#define SYS_CLK_BASE SYS_TIMER_BASE
#define SYS_CLK_FREQ SYS_TIMER_FREQ
#define SYS_CLK_IRQ_INTERRUPT_CONTROLLER_ID SYS_TIMER_IRQ_INTERRUPT_CONTROLLER_ID
#endif
...
#else
	//Aaron 20170829
	if ( -EINVAL ==     alt_ic_isr_register(SYS_TIMER_IRQ_INTERRUPT_CONTROLLER_ID, SYS_TIMER_IRQ,
			vPortSysTickHandler, 0x0, 0x0) )
#endif
