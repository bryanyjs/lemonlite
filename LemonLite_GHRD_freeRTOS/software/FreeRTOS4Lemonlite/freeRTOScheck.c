...
#if 0
#define mainREG_TEST_1_PARAMETER    ( ( void * ) SDRAM_BASE+SDRAM_SPAN-1 )
#define mainREG_TEST_2_PARAMETER    ( ( void * ) SDRAM_BASE+SDRAM_SPAN )

#else

//20170829 Aaron
#define mainREG_TEST_1_PARAMETER    ( ( void * ) SDRAM_CONTROLLER_BASE+SDRAM_CONTROLLER_SPAN-1 )
#define mainREG_TEST_2_PARAMETER    ( ( void * ) SDRAM_CONTROLLER_BASE+SDRAM_CONTROLLER_SPAN )
